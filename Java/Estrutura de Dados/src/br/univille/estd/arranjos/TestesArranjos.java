...
class TestesArranjos {
	...
	void exercicio02() {
		...
		assertEquals("aa",a[0],"A primeira posicao do arranjo deve conter o valor \"aa\"");
		assertEquals("bb",a[1],"A segunda posicao do arranjo deve conter o valor \"bb\"");
		assertEquals("cc",a[2],"A terceira posicao do arranjo deve conter o valor \"cc\"");
	}
	...
	void exercicio06() {
		...
		int z[] = {0,1,2,2,-1};
		total = Arranjos.exercicio06(z);
		assertEquals(4,total,"O total esta incorreto");
		int y[] = {-1,-1,-1,-1};
		total = Arranjos.exercicio06(y);
		assertEquals(-4,total,"O total esta incorreto");
	}
	...
	void exercicio07() {
		int x[] = {1,1,1,1,1};
		int total = Arranjos.exercicio07(x);
		assertEquals(5,total,"O total esta incorreto");
		int z[] = {0,1,2,2,1};
		total = Arranjos.exercicio07(z);
		assertEquals(2,total,"O total esta incorreto");
		int y[] = {0,4,6,8};
		total = Arranjos.exercicio07(y);
	...
	void exercicio08() {
		...
		assertArrayEquals(x, z, "Elementos dos vetores devem ser iguais");
		int w[] = {4,7,9,4};
		int p[] = new int[4];
		int u[] = Arranjos.exercicio08(w,p);
		assertNotEquals(w, p, "Nao pode retornar o vetor A");
		assertArrayEquals(w, u, "Elementos dos vetores devem ser iguais");
	...
	void exercicio09() {
		...
		int w[] = {4,7,9,4};
		int p[] = {4, 9, 7, 4};
		int u[] = Arranjos.exercicio09(w);
		assertArrayEquals(p, u, "Deve retornar o vetor com valores invertidos");
